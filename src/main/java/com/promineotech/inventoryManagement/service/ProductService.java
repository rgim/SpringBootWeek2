...
public class ProductService {
	...
	public Product updateProduct(Product product, Long id) throws Exception {
		try {
			...
			Optional<Product> possibleProduct;
			Product oldProduct;
			possibleProduct = repo.findById(id);
			oldProduct = possibleProduct.get();
	...
	public void removeProduct(Long id) throws Exception {
		try {
			...
			logger.error("Excpetion occurred while trying to delete product: " + id, e);
